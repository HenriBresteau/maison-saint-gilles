      ...
      <div className="grid gap-10 md:grid-cols-2">
        <div className="flex flex-col gap-8">
          ...
          <h1 className="font-monsterrat text-4xl font-semibold tracking-tight text-navy-900 md:text-6xl">
            Maison de Vacances{" "}
            <span className="inline-block bg-gradient-to-r from-coral-600 via-navy-700 to-coral-800 bg-clip-text text-transparent">
              en Vendée
            </span>
          </h1>
          <p>
        ...
        <div className="relative flex h-full w-full justify-center">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-4xl border border-slate-600">
            <Image
              src="/ext_2.png"
